<?php
	...
	$panelcuentas = new Panel("../html/u_viaje_multi_sinestadia.html");

	
	$result= mysql_query("SELECT v.via_id, v.via_tipoviaje, v.via_fecha_ini, v.via_fecha_fin, v.via_hora_ini, v.via_hora_fin, v.via_cant_per,v.fk_via_id_origen,v.fk_via_id_destino,v.via_compuesto,p.pre_paseo FROM  viaje v, presupuesto p  WHERE  p.fk_per_cedula='$cedula' AND v.fk_pre_id=p.pre_id  and v.via_tipo='Viaje' and p.pre_habitacion is null and p.pre_paseo is not null ORDER BY p.pre_paseo");
