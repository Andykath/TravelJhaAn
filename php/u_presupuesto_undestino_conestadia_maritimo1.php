<?php
	...
	//echo($locura);
		  ...
		  {//aqui pinta el editor por primera vez	
					...
					$panelestadios = new Panel("../html/u_presupuesto_undestino_conestadia_maritimo1.html");
					$panelestadios->add("form",'<form name="form1" method="post" action="../php/u_presupuesto_undestino_conestadia_maritimo1.php?a=1">');
