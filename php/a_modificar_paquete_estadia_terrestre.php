<?php
	...
	extract($_POST);
		...
		//echo "$cue_numero cuenumero, $fecha fecha, $fecha1 fecha1, $millas millas, $tipopaq tipopaq, $cantper cantper, $banco banco, $banco1 banco1, $hotel hotel";
		  ...
		  {//aqui pinta el editor por primera vez	
					...
					$panelestadios->add("form",'<form name="form1" method="post" action="../php/a_modificar_paquete_estadia_terrestre.php?cue_id='.$id.'&cue_numero='.$tipoviaje.'&fecha='.$fechai.'&fecha1='.$fechaf.'&millas'.$millas.'&tipopaq='.$tipopaq.'&cantper='.$cantper.'&banco='.$banco.'&banco1='.$banco1.'&hotel='.$hotel.'&cue_id='.$id.'">');
