<?php
	...
	$panelmiperfil = new Panel("../html/a_verperfil_paquete_estadia_aerolineas.html");
   ...
   $cedula_actual=$_SESSION['cedula'];
	...
	$panelmiperfil->add("hotel",$hotel);
	//$panelmiperfil->add("fechaie",$fechaie);
	//$panelmiperfil->add("fechafe",$fechafe);
	//$panelmiperfil->add("hab",$habid);
	$panelmiperfil->add("links",'<a href="../php/a_modificar_paquete_estadia_aerolinea.php?tipoviaje='.$tipoviaje.'&id='.$id.'&fechai='.$fechai.'&fechaf='.$fechaf.'&millas='.$millas.'&tipopaq='.$tipopaq.'&cantpaq='.$cantpaq.'&aernombre='.$aernombre.'&aerid='.$aerid.'&fkvia='.$fkvia.'&fkvia2='.$fkvia2.'&hotel='.$hotid.'">Modificar</a> <a href="../php/a_eliminar_paquete_estadia_aerolinea.php?id='.$id.'" onclick="return confirmar()">Eliminar</a>');
