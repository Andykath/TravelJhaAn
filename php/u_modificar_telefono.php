<?php
	...
	extract($_POST);
               ...
               if (($estadio_viejo== $numero)&&($ciudad_vieja==$tipo))    
				...
				else 
				{
					...
					{//1
					  ...
					  {
					  		$hola='u_telefonos.php?cedula='.$cedula.'&mensaje=3';
				            header("Location:$hola");		
		  ...
		  {//aqui pinta el editor por primera vez	
					...
					$panelestadios = new Panel("../html/u_crear_telefono.html");
					$panelestadios->add("form",'<form name="form1" method="post" action="../php/u_modificar_telefono.php?cod='.$id.'&cedula='.$cedula.'&numero='.$numero.'">');
