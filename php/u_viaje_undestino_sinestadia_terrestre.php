<?php
	...
	$panelcuentas = new Panel("../html/u_viaje_undestino_sinestadia_terrestre.html");
	
	
	

	$result= mysql_query("SELECT v.via_id, v.via_tipoviaje, v.via_fecha_ini, v.via_fecha_fin, v.via_hora_ini, v.via_hora_fin, v.via_cant_per, a.ter_nombre, d.des_nombre, o.des_nombre
FROM via i, via f, destino d, destino o, terrestre a, viaje v, presupuesto p
