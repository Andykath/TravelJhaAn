...
//echo($viaje);
			...
			//echo($pago);
				...
				$hola='u_continuar_compra_undestino_sinestadia_aereo.php?viaje='.$viaje.'&cantper='.$cantper.'&cedula='.$cedula.'&mensaje=2';
		...
		//	echo($pago2);
			//echo("pago2");
					...
					mysql_query("UPDATE `presupuesto` SET  `pre_status` = 'Comprado' WHERE  `presupuesto`.`pre_id` = $id");
					   ...
					   $hola1='u_continuar_compra_undestino_sinestadia_aereo.php?viaje='.$viaje.'&cantper='.$cantper.'&cedula='.$cedula.'&mensaje=2';
