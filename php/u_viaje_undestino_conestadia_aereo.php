<?php
	...
	$result= mysql_query("SELECT v.via_id, v.via_tipoviaje, v.via_fecha_ini, v.via_fecha_fin, v.via_hora_ini, v.via_hora_fin, v.via_cant_per, a.aer_nombre, d.des_nombre, o.des_nombre, ho.hot_nombre, ha.hab_id, e.est_fecha_ini, e.est_fecha_fin
FROM via i, via f, destino d, destino o, aerolinea a, hotel ho, viaje v, habitacion ha, presupuesto p, estadia e
