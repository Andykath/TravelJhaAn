 ...
 mysql_query("INSERT INTO `presupuesto` (`pre_id`, `pre_fecha`,`pre_habitacion`,`pre_servicio`,`pre_paseo`,`pre_total`,`pre_cant_per`,`fk_per_cedula`, `fk_via_id_origen`, `fk_via_id_destino`,`pre_abono`,`pre_status`) VALUES (NULL ,'".$_POST['fecha']."','".$_POST['habitacion']."','".$_POST['servicio']."','$mivariable1', '".$_POST['total']."','".$_POST['cant1']."', '$cedula','".$_POST['combotra']."', '".$_POST['combotra1']."',0,'No comprado')");
	...
	$last = mysql_query("SELECT max(pre_id) as max FROM presupuesto"); 
				...
				mysql_query("INSERT INTO `pre_pas` (`pre_id`, `fk_pre_id`,`fk_pas_id`) VALUES (NULL ,'$este','$pas8')");}
								...
								else if ($_POST['estadia']=='No')
								{
								
							
								 mysql_query("INSERT INTO `presupuesto` (`pre_id`, `pre_fecha`,`pre_habitacion`,`pre_servicio`,`pre_paseo`,`pre_total`,`pre_cant_per`,`fk_per_cedula`, `fk_via_id_origen`, `fk_via_id_destino`,`pre_abono`,`pre_status`) VALUES (NULL ,'".$_POST['fecha']."',null,NULL,'$mivariable1', '".$_POST['total']."','".$_POST['cant1']."', '$cedula','".$_POST['combotra']."', '".$_POST['combotra1']."',0,'No comprado')");
								}
      ...
      $panelcuentas->add("combo",'<tr><td>*Tipo de Transporte:</td><td><select name="combo" id="combo" onChange="populate(document.form1,document.form1.fecha.value,document.form1.combo.options[document.form1.combo.selectedIndex].value,document.form1.mivariable.value)"><option selected="selected">Seleccione</option><option>Aereo</option><option>Maritimo</option><option>Terrestre</option></select></td></tr>');
			...
			$panelcuentas->add("combotra",' <tr><td>Crucero:</td><td><select name="combotra" id="combotra" onChange="populate2(document.form1,document.form1.fecha.value,document.form1.combo.options[document.form1.combo.selectedIndex].value,document.form1.combotra.options[document.form1.combotra.selectedIndex].value,document.form1.mivariable.value)">'.$select.'</td></tr>');
	  ...
	  $panelcuentas->add("estadia",' <tr><td>Desea su destino con estadia?:</td><td><select name="estadia" id="estadia"><option>Seleccione</option><option>Si</option><option>No</option></td></tr>');
				       ...
				       if ("Aereo"==$selected)
							{
							  ...
							  $result2= mysql_query("select * from crucero");
								...
								{				
									...
									if ($row2["cru_id"]==$selected2){
										//echo 'if';
										$select_actual22='<option selected="selected" value="'.$row2["cru_id"].'">'.$row2["cru_nombre"].'</option>'; }	
									else{
										//echo "banco es $banco";
										$select_actual22='<option value="'.$row2["cru_id"].'">'.$row2["cru_nombre"].'</option>'; 	}	
									$select22=$select22.$select_actual22;
								}
								
								$panelcuentas->add("combotra",' <tr><td>Crucero:</td><td><select name="combotra" id="combotra" onChange="populate2(document.form1,document.form1.fecha.value,document.form1.combo.options[document.form1.combo.selectedIndex].value,document.form1.combotra.options[document.form1.combotra.selectedIndex].value,document.form1.mivariable.value)">'.$select22.'</td></tr>');
        ...
        <option>10</option>
								...
								$devuelve1=$ro1['fk_des_id'];		
					    $select1='<option>Seleccione</option>';
						$result1= mysql_query("SELECT distinct r.fk_flo_id FROM ruta r WHERE fk_flo_id IN (SELECT flo_id FROM flota WHERE fk_cru_id =$selected2)");
						while($row1 = mysql_fetch_array($result1))
						{
						...
						$panelcuentas->add("combotra1",' <tr><td>Barco/Ruta:</td><td><select name="combotra1" id="combotra1"onChange="populate3(document.form1,document.form1.fecha.value,document.form1.combo.options[document.form1.combo.selectedIndex].value,document.form1.combotra.options[document.form1.combotra.selectedIndex].value,document.form1.combotra1.options[document.form1.combotra1.selectedIndex].value,document.form1.cant1.options[document.form1.cant1.selectedIndex].value,document.form1.mivariable.value)">'.$select1.'</td></tr>');
        ...
        <option>10</option>
						...
						$panelcuentas->add("combotra1",' <tr><td>T.Terrestre/Destino:</td><td><select name="combotra1" id="combotra1"onChange="populate3(document.form1,document.form1.fecha.value,document.form1.combo.options[document.form1.combo.selectedIndex].value,document.form1.combotra.options[document.form1.combotra.selectedIndex].value,document.form1.combotra1.options[document.form1.combotra1.selectedIndex].value,document.form1.cant1.options[document.form1.cant1.selectedIndex].value,document.form1.mivariable.value)">'.$select1.'</td></tr>');
							...
							//echo "hotel $hotel";
							  if ($selected && $fechai && $selected2 && $selected3 && $selected4 && $selected7 && $mivariable && (!(isset($hotel))))
						{
							  if ($selected=='Aereo')
							  {
								  if($selected7=='Si')
		...
		$select22='<option>Seleccione</option>';
						...
						if ($selected4==1){
						$panelcuentas->add("cant1",'<tr> <td>Cant Personas (Incluyendo al presupuestante):</td><td><select name="cant1" id="cant1"><option selected="selected">1</option>
													<option>2</option>
													<option>3</option>
													<option>4</option>
													<option>5</option>
													...
													<option>10</option>');}
						if ($selected4==2){
						$panelcuentas->add("cant1",'<tr> <td>Cant Personas (Incluyendo al presupuestante):</td><td><select name="cant1" id="cant1"><option>1</option>
						...
						$panelcuentas->add("cant1",'<tr> <td>Cant Personas (Incluyendo al presupuestante):</td><td><select name="cant1" id="cant1"><option>1</option>
													...
													if ($selected7=='Si'){
														 $panelcuentas->add("estadia",' <tr><td>Desea su destino con estadia?:</td><td><select name="estadia" id="estadia"><option>Seleccione</option><option selected="selected">Si</option><option>No</option></td></tr>');
						}
						
						if ($selected7=='No'){
														 $panelcuentas->add("estadia",' <tr><td>Desea su destino con estadia?:</td><td><select name="estadia" id="estadia"><option>Seleccione</option><option>Si</option><option selected="selected">No</option></td></tr>');
						}
		...
		$select22='<option>Seleccione</option>';
		 ...
		 $select22='<option>Seleccione</option>';
						...
						$select5='<option>Seleccione</option>';
						$result5= mysql_query("SELECT h.hab_id, h.hab_costo, h.hab_categoria FROM  habitacion h  WHERE h.fk_cru_id=$selected3 AND h.hab_status='No ocupada'");
						...
						$panelcuentas->add("hoteles",' <tr><td>Camarote:</td><td><select name="hotel" id="hotel" onChange="populate4(document.form1,document.form1.fecha.value,document.form1.combo.options[document.form1.combo.selectedIndex].value,document.form1.combotra.options[document.form1.combotra.selectedIndex].value,document.form1.combotra1.options[document.form1.combotra1.selectedIndex].value,document.form1.cant1.options[document.form1.cant1.selectedIndex].value,document.form1.mivariable.value,document.form1.hotel.options[document.form1.hotel.selectedIndex].value,document.form1.estadia.options[document.form1.estadia.selectedIndex].value)"><option>Seleccione</option>'.$select5.'</td></tr>');
		...
		$select22='<option>Seleccione</option>';
						...
						$panelcuentas->add("hoteles",' <tr><td>Hotel:</td><td><select name="hotel" id="hotel" onChange="populate4(document.form1,document.form1.fecha.value,document.form1.combo.options[document.form1.combo.selectedIndex].value,document.form1.combotra.options[document.form1.combotra.selectedIndex].value,document.form1.combotra1.options[document.form1.combotra1.selectedIndex].value,document.form1.cant1.options[document.form1.cant1.selectedIndex].value,document.form1.mivariable.value,document.form1.hotel.options[document.form1.hotel.selectedIndex].value,document.form1.mivariable.value,document.form1.estadia.options[document.form1.estadia.selectedIndex].value)"><option>Seleccione</option>'.$select4.'</td></tr>');
      ...
      <td>Habitacion:</td>
      <td><select name="habitacion" id="habitacion"><option value="z">Seleccione</option>';
						$result5= mysql_query("SELECT h.hab_id, h.hab_costo,  h.hab_categoria FROM  habitacion h  WHERE h.fk_cru_id=$hotel AND h.hab_status='No ocupada'");
						while($row5 = mysql_fetch_array($result5))
						{
						$select_actual5='<option value="'.$row5["hab_id"].'">'.$row5["hab_id"].' Costo:'.$row5["hab_costo"].' Cat:'.$row5["hab_categoria"].'</option>'; 
						$select5=$select5.$select_actual5;
      ...
      <td>*Servicios:</td>
      <td><select name="servicio" id="servicio"><option value="z">No deseo Servicios</option>';
						$result7= mysql_query("SELECT s.ser_nombre, s.ser_descripcion,s.ser_id,s.ser_costo FROM  servicio s, cru_ser hs WHERE hs.fk_flo_id=$hotel AND hs.fk_ser_id=s.ser_id");
						while($row7 = mysql_fetch_array($result7))
						{
						$select_actual7='<option value="'.$row7["ser_id"].'">'.$row7["ser_nombre"].'/'.$row7["ser_descripcion"].'/'.$row7["ser_costo"].'</option>'; 
						$select7=$select7.$select_actual7;
      ...
      <td><select name="tipoviaje" id="tipoviaje" onChange= "populate6(document.form1.mivariable.value)">
		...
		$select22='<option>Seleccione</option>';
						...
						while($row12 = mysql_fetch_array($result12))
								{		
								$result6= mysql_query("SELECT c.cos_costo FROM  costo c WHERE c.fk_via_origen=$combotra AND c.fk_via_destino=".$row12["via_id"]."");
							 $row6 = mysql_fetch_array($result6);			
