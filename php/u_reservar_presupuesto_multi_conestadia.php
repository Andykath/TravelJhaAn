<?php
	...
	if ($mete1>0){
			...
			if($cantper==1)
			 ...
			 //echo("$hola,$fecha,$cantper,$id,$origen1,$destino1");
				...
				$hola='u_presupuesto_multi_conestadia.php?mensaje=1';
	...
	$hola='u_abono_error_multi_conestadia.php?mensaje=1';
	header("Location:$hola");
	      ...
	      else
		  {
			...
			$panelestadios = new Panel("../html/u_reservar_presupuesto_multi_conestadia.html");
			$panelestadios->add("form",'<form name="form1" method="post" action="../php/u_reservar_presupuesto_multi_conestadia.php?a=1&id='.$id.'&cantper='.$cantper.'&origen1='.$origen1.'&fecha='.$fecha.'&destino1='.$destino1.'&paseo='.$paseo.'">');
				...
				$via=mysql_query("SELECT fk_aer_id, fk_cru_id , fk_ter_id FROM  via where via_id='$mivariable'");
					 ...
					 {
						 //echo("entra");
						$via2=mysql_query("SELECT o.des_nombre,d.des_nombre,a.aer_nombre FROM  via v, aerolinea a, destino o, destino d, via f where v.via_id='$origen1' AND f.via_id='$destino1' and v.fk_aer_id=a.aer_id and v.fk_des_id=o.des_id and f.fk_des_id=d.des_id");
	    ...
	    $admin->add("contenido",$panelestadios);
	        $admin->show();	
							 ...
							 if ($ter)
							 {
								 $via4=mysql_query("SELECT o.des_nombre,d.des_nombre,a.ter_nombre FROM  via v, terrestre a, destino o, destino d, via f where v.via_id='$origen1' AND f.via_id='$destino1' and v.fk_ter_id=a.ter_id and v.fk_des_id=o.des_id and f.fk_des_id=d.des_id");
