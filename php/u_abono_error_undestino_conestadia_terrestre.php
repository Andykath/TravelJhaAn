<?php
	...
	//echo($locura);
		  ...
		  {//aqui pinta el editor por primera vez	
					...
					$panelestadios = new Panel("../html/u_abono_error.html");
					$panelestadios->add("form",'<form name="form1" method="post" action="../php/u_abono_error_undestino_conestadia_terrestre.php?a=1">');
