<?php
    ...
    <tr align="center">
	  ...
	  <td width="200"><a href="../php/u_comprar_undestino_sinestadia_terrestre.php?id='.$row['pre_id'].'&fecha='.$row['pre_fecha'].'&aerolinea='.$row['ter_nombre'].'&origen='.$row[3].'&destino='.$row[4].'&total='.$row['pre_total'].'&cantper='.$row['pre_cant_per'].'&origen1='.$row[11].'&destino1='.$row[12].'&hotel1='.$row[13].'">Comprar</a> </td>
    </tr>';
