<?php
	...
	extract($_POST);
		  ...
		  {//aqui pinta el editor por primera vez	cyo lo acabo d hacer tb :S ya va
					...
					$panelcuentas = new Panel("../html/a_modificar_paquete_sinestadia_aerolinea.html");
					$panelcuentas->add("form",'<form name="form1" method="post" action="../php/a_modificar_paquete_sinestadia_aerolinea2.php">');
