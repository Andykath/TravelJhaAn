<?php
 ...
 if($viaje && !(isset($nombre1)) && ($preg=="Si"))
		  { 	
...
$hola='u_verboleto_undestino_conestadia_maritimo.php?viaje='.$viaje.'&mensaje=1&preg='.$preg.'';
header("Location:$hola");
	      ...
	      else
		  {
			...
			$panelestadios = new Panel("../html/u_continuar_compra_undestino_conestadia_maritimo.html");
			$panelestadios->add("form",'<form name="form1" method="post" action="../php/u_continuar_compra_undestino_conestadia_maritimo.php?viaje='.$viaje.'&preg='.$preg.'">');
