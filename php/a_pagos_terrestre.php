<?php
	...
	$panelcuentas = new Panel("../html/a_pagos_terrestre.html");
	$panelcuentas->add("crear",'<a href="../php/a_crear_pagos_terrestre.php?mensaje=1">Crear Pago</a>');
	...
	{
		$panelcuentas->add("error",'Este vieje ya tiene sus boletos');
	}
	$result= mysql_query("SELECT p. * , v.via_id, v.via_id,   v.fk_via_id_origen, v.fk_via_id_destino, e.ter_nombre FROM viaje v, pago p, via a, terrestre e WHERE p.fk_via_id = v.via_id AND a.fk_ter_id = e.ter_id AND v.fk_via_id_origen = a.via_id ");
