<?php
	...
	if ($mete1>0){
			...
			if($cantper==1)
			 ...
			 //echo("$hola,$fecha,$cantper,$id,$origen1,$destino1");
				...
				$hola='u_presupuesto_undestino_sinestadia_terrestre.php?mensaje=1';
	...
	$hola='u_abono_error_undestino_sinestadia_terrestre.php?mensaje=1';
	header("Location:$hola");
	      ...
	      else
		  {
			...
			$panelcuentas = new Panel("../html/u_reservar_presupuesto_undestino_sinestadia_terrestre.html");
			$panelcuentas->add("form",'<form name="form1" method="post" action="../php/u_reservar_presupuesto_undestino_sinestadia_terrestre.php?a=1&id='.$id.'&cantper='.$cantper.'&origen1='.$origen1.'&fecha='.$fecha.'&destino1='.$destino1.'">');
