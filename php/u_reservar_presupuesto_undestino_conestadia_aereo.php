<?php
	...
	$hola='u_abono_error_undestino_conestadia_aereo.php?mensaje=1';
	header("Location:$hola");
	      ...
	      else
		  {
			...
			$panelcuentas = new Panel("../html/u_reservar_presupuesto_undestino_conestadia_aereo.html");
			$panelcuentas->add("form",'<form name="form1" method="post" action="../php/u_reservar_presupuesto_undestino_conestadia_aereo.php?a=1&id='.$id.'&cantper='.$cantper.'&origen1='.$origen1.'&fecha='.$fecha.'&destino1='.$destino1.'">');
