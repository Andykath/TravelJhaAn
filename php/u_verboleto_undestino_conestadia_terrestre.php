<?php
	...
	$paneldetallefactura = new Panel("../html/u_verboleto_undestino_conestadia_terrestre.html");
...
if ($preg=="Si"){
   ...
   <tr>
      ...
      <tr>
        <td width="34" align="center"><strong>Nro. Piso: </strong>2</td>
        <td width="126" align="center"><strong>Nro. Zona: </strong>C-1</td>
      </tr>
	  </tr>
