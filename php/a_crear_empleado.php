<?php
	...
	extract($_POST);
	      ...
	      if($cedula)
		  {
		     ...
		     $result1= mysql_query("SELECT * FROM persona p WHERE p.per_cedula ='$cedula'");
			  ...
			  if (mysql_fetch_array($result1))
			  {
					...
					$panelciudades = new Panel("../html/a_crear_empleado.html");
					$panelciudades->add("form",'<form name="form1" method="post" action="../php/a_crear_empleado.php">');
					...
					$panelciudades->add("error",'Ya existe ese empleado');
	      ...
	      else
		  {
			...
			$admin= new Panel("../html/admin.html");
			$admin->add("body",'<body onLoad = "actual(4)" >');
			$panelcuentas = new Panel("../html/a_crear_empleado.html");
			$panelcuentas->add("form",'<form name="form1" method="post" action="../php/a_crear_empleado.php">');
