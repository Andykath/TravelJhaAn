	...
	//print_r($_POST); 
		  if($total && !(isset($sipo)))
		  {
			...
			//echo("entra  $total $total");
				...
				$hola='a_presupuesto_undestino_conestadia_aereo.php?mensaje=1';
	      ...
	      else
		  {
			...
			$panelcuentas = new Panel("../html/a_crear_presupuesto_undestino_conestadia_aereo.html");
			$panelcuentas->add("form",'<form name="form1" method="post" action="../php/a_crear_presupuesto_undestino_conestadia_aereo.php?">');
