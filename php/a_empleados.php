<?php
	...
	$panelpaises = new Panel("../html/a_empleados.html");
	...
	$tabla_completa='';
	$result= mysql_query("SELECT p.per_cedula, p.per_nombre1 ,p.per_apellido1 FROM persona p WHERE p.per_tipo='Empleado' ORDER BY p.per_cedula");
  ...
  '<tr align="center">
	 ...
	 <td width="279"><a href="../php/a_ver_perfil.php?ced='.$row['per_cedula'].'">Ver Perfil</a> </td>
    </tr>';
