...
$hola='a_verboleto_undestino_conestadia_aereo.php?viaje='.$viaje.'&mensaje=1&preg='.$preg.'';
header("Location:$hola");
	      ...
	      else
		  {
			...
			$panelestadios->add("form",'<form name="form1" method="post" action="../php/a_continuar_compra_undestino_conestadia_aereo.php?viaje='.$viaje.'&preg='.$preg.'">');
