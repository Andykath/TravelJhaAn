<?php
	...
	extract($_POST);
		  ...
		  //echo "aja";
			//echo $forma_pago."aja";
			//echo $monto."1";//primer monto
			//echo $pago."2";//primer tipo de pago
			//echo $pago2."3";//segundo tipo de pago
			//echo $monto2."4";//segundo monto
		//echo $numero;
			if ($forma_pago==1)
			{
				//echo "1";
	      ...
	      else
		  {
			...
			$panelcuentas = new Panel("../html/a_crear_pago_maritimo.html");
			$panelcuentas->add("form",'<form name="form1" method="post" action="../php/a_crear_pago_maritimo.php">');
