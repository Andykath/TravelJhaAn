...
$hola='u_verboleto_undestino_conestadia_terrestre.php?viaje='.$viaje.'&mensaje=1&preg='.$preg.'';
header("Location:$hola");
	      ...
	      else
		  {
			...
			$panelestadios->add("form",'<form name="form1" method="post" action="../php/u_continuar_compra_undestino_conestadia_terrestre.php?viaje='.$viaje.'&preg='.$preg.'">');
