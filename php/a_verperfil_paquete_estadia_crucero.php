<?php
	...
	$panelmiperfil = new Panel("../html/a_verperfil_paquete_estadia_crucero.html");
   ...
   $cedula_actual=$_SESSION['cedula'];
	...
	$panelmiperfil->add("links",'<a href="../php/a_modificar_paquete_estadia_crucero.php?tipoviaje='.$tipoviaje.'&id='.$id.'&fechai='.$fechai.'&fechaf='.$fechaf.'&millas='.$millas.'&tipopaq='.$tipopaq.'&cantpaq='.$cantpaq.'&aernombre='.$aernombre.'&aerid='.$aerid.'&fkvia='.$fkvia.'&fkvia2='.$fkvia2.'&hotel='.$hotid.'">Modificar</a> <a href="../php/a_eliminar_paquete_estadia_crucero.php?id='.$id.'" onclick="return confirmar()">Eliminar</a>');
