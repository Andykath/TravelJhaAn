	      ...
	      if($cue_numero)
		  {
		     ...
		     $result1= mysql_query("SELECT * FROM via v WHERE v.via_terminal ='$cue_numero'");
			  ...
			  if (mysql_fetch_array($result1))
			  {
					...
					$panelcuentas = new Panel("../html/a_crear_costo_crucero.html");
					...
					$select='';
					$result= mysql_query("SELECT * FROM  crucero c");
			  ...
			  {
				mysql_query("INSERT INTO `via` (`via_id` ,`via_costo` ,`via_terminal` ,`via_millas`, `fk_des_id`, `fk_aer_id`, `fk_cru_id` , `fk_ter_id`)VALUES (NULL ,'$tipo', '$cue_numero',  '$fecha', '$destino',NULL, '$banco', NULL)");
