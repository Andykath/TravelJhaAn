<?php
	...
	extract($_GET);
	      ...
	      if($cue_numero)
		  {
				...
				mysql_query("INSERT INTO `habitacion` (`hab_id` ,`hab_piso` ,`hab_tipo` ,`hab_capacidad` ,`hab_costo`,`fk_cru_id`, `fk_hot_id`)VALUES (NULL ,  '$cue_numero',  'Crucero',  '$fecha',  '$banco', '$hot_id', NULL)");
