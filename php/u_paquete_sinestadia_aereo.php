<?php
	...
	$panelcuentas = new Panel("../html/u_paquete_sinestadia_aereo.html");
	
	$mensaje = $_REQUEST['mensaje'];

	$result= mysql_query("SELECT v.via_id,v.via_tipoviaje,v.via_millas,v.via_cant_per,v.fk_via_id_origen,v.fk_via_id_destino,d.des_nombre, o.des_nombre, a.aer_nombre, a.aer_id, v.via_tipo_paq,f.via_costo
