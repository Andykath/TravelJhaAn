<?php
	...
	$result2= mysql_query("SELECT v.via_id,v.fk_flo_id, v.via_fecha_ini, v.via_fecha_fin, v.via_hora_ini, v.via_hora_fin, d.des_nombre, vi.via_terminal, a.cru_nombre FROM viaje v, via vi, destino d, crucero a
WHERE v.via_id = '$viaje' AND v.fk_via_id_destino = vi.via_id AND vi.fk_des_id = d.des_id
AND vi.fk_cru_id=a.cru_id ORDER BY v.via_id");
   ...
   <tr>
      <td colspan="10"><p><p><img src="../imagenes/logo.gif" width="200" height="113" align="right" /></p>
        <strong>© Copyright Viajes Ucab | Producciones SzcoPa.</strong></p>
		  ...
		  <p><strong>Crucero:</strong>'.$aerolinea.'</p>
		  <p><strong>Flota:</strong>'.$flota.'</p>
		  <p><strong>Lugar destino:</strong>'.$destino.'</p>
		  <p><strong>Puerto:</strong>'.$aeropuerto.'</p>
      ...
      <tr>
        ...
        <td width="126" align="center"><strong>Nro. Zona: </strong>B</td>
      </tr>
	  </tr>
