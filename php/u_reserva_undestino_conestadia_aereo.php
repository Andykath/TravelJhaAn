<?php
    ...
    <tr align="center">
	  ...
	  <td width="300"><a href="../php/u_comprarR_undestino_conestadia_aereo.php?id='.$row['pre_id'].'&fecha='.$row['pre_fecha'].'&aerolinea='.$row['aer_nombre'].'&origen='.$row[3].'&destino='.$row[4].'&hotel='.$row['hot_nombre'].'&habitacion='.$row['pre_habitacion'].'&servicio='.$row['ser_nombre'].'&paseo='.$row['pas_nombre'].'&total='.$row['pre_total'].'&cantper='.$row['pre_cant_per'].'&origen1='.$row[11].'&destino1='.$row[12].'&hotel1='.$row[13].'&id2='.$row['via_id'].'">Comprar</a> <a href="../php/u_verpaseo_undestino_conestadia_aereo.php?id='.$row['pre_id'].'">Ver Paseos</a> </td>
    </tr>';
