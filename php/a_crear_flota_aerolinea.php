	      ...
	      if($cue_numero)
		  {
		     ...
		     $result1= mysql_query("SELECT * FROM flota f WHERE f.flo_nombre ='$cue_numero'");
			  ...
			  if (mysql_fetch_array($result1))
			  {
					...
					$panelcuentas = new Panel("../html/a_crear_flota_aerolinea.html");
					$panelcuentas->add("form",'<form name="form1" method="post" action="../php/a_crear_flota_aerolinea.php">');
			  ...
			  {
				mysql_query("INSERT INTO `flota` (`flo_id` ,`flo_nombre` ,`flo_capacidad` ,`flo_cantidad`,`flo_actual`, `fk_aer_id`)VALUES (NULL ,'$cue_numero', '$fecha',  '$tipo','$fecha', '$banco')");
