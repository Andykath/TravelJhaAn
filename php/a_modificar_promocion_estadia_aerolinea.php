<?php
	...
	extract($_POST);
		    ...
		    //echo($des);
			 //echo($dur);
			  //echo($fkvia);
					...
					$hola='a_promociones_estadia_aerolineas.php?mensaje=2';
		  ...
		  {//aqui pinta el editor por primera vez	
					...
					$panelestadios = new Panel("../html/a_modificar_promocion_estadia_aerolinea.html");
					$panelestadios->add("form",'<form name="form1" method="post" action="../php/a_modificar_promocion_estadia_aerolinea.php?cue_id='.$id.'&cue_numero='.$nombrepro.'&fechai='.$fechai.'&fechaf='.$fechaf.'&des'.$descuento.'&dur='.$duracion.'&fkvia='.$banco.'">');
