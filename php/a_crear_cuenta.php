<?php
	...
	extract($_POST);
	      ...
	      if($cue_numero)
		  {
		     ...
		     $result1= mysql_query("SELECT * FROM cuenta_bancaria c WHERE c.cue_numero ='$cue_numero'");
			  ...
			  if (mysql_fetch_array($result1))
			  {
					...
					$panelcuentas = new Panel("../html/a_crear_cuenta.html");
					$panelcuentas->add("form",'<form name="form1" method="post" action="../php/a_crear_cuenta.php">');
			  ...
			  {
				mysql_query("INSERT INTO `cuenta_bancaria` (`cue_id` ,`cue_numero` ,`cue_tipo` ,`cue_fecha_apertura` ,`fk_ban_id`)VALUES (NULL ,  '$cue_numero',  '$tipo',  '$fecha',  '$banco')");
			    
				$hola='a_cuentasbancarias.php?mensaje=1';
