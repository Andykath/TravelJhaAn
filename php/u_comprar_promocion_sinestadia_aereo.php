...
////echo($viaje);
		    ...
		    $pago2=$roc['max'];
					...
					//si esta el presu 	
					 ...
					 } $hola1='u_promocion2_conestadia_aereo1.php?mensaje=2';
				           header("Location:$hola1");
		    ...
		    $pago1=$rob['max'];
					 ...
					 // echo("trina");
						...
						$flota1=$rohola['flo_id'];	
							...
							mysql_query("INSERT INTO `presupuesto` (`pre_id`, `pre_fecha`,`pre_habitacion`,`pre_servicio`,`pre_paseo`,`pre_total`,`pre_cant_per`,`fk_per_cedula`, `fk_via_id_origen`, `fk_via_id_destino`,`pre_abono`,`pre_status`,`pre_paq`,`pre_pro`) VALUES (NULL ,'2011-06-18',null,NULL,NULL, '$total','$cantper', '$cedula','$viaorigen', '$viadestino',$monto+$monto1,'No comprado',null,'$id')");
					 }
					 else
					 {
		    ...
		    $pago2=$roc['max'];
					 ...
					 if ($dimeya== NULL )
					 {
						...
						$flota1=$rohola['flo_id'];	
							...
							mysql_query("INSERT INTO `presupuesto` (`pre_id`, `pre_fecha`,`pre_habitacion`,`pre_servicio`,`pre_paseo`,`pre_total`,`pre_cant_per`,`fk_per_cedula`, `fk_via_id_origen`, `fk_via_id_destino`,`pre_abono`,`pre_status`,`pre_paq`,`pre_pro`) VALUES (NULL ,'2011-06-18',null,NULL,NULL, '$total','$cantper', '$cedula','$viaorigen', '$viadestino',($monto+$monto2),'No comprado',null,'$id')");
					 }
					 else
					 {
		    ...
		    $pago2=$roc['max'];
					 ...
					 if ($dimeya== NULL )
					 {
						...
						$flota1=$rohola['flo_id'];	
							 ...
							 mysql_query("INSERT INTO `presupuesto` (`pre_id`, `pre_fecha`,`pre_habitacion`,`pre_servicio`,`pre_paseo`,`pre_total`,`pre_cant_per`,`fk_per_cedula`, `fk_via_id_origen`, `fk_via_id_destino`,`pre_abono`,`pre_status`,`pre_paq`,`pre_pro`) VALUES (NULL ,'2011-06-18',null,NULL,NULL, '$total','$cantper', '$cedula','$viaorigen', '$viadestino',($monto1+$monto2),'No comprado',null,'$id')");
					 }
					 else
					 {
			...
			$rodime = mysql_fetch_array($dime);
					 ...
					 if ($dimeya== NULL )
					 {
						...
						$flota1=$rohola['flo_id'];	
							...
							mysql_query("INSERT INTO `presupuesto` (`pre_id`, `pre_fecha`,`pre_habitacion`,`pre_servicio`,`pre_paseo`,`pre_total`,`pre_cant_per`,`fk_per_cedula`, `fk_via_id_origen`, `fk_via_id_destino`,`pre_abono`,`pre_status`,`pre_paq`,`pre_pro`) VALUES (NULL ,'2011-06-18',null,NULL,NULL, '$totalaux','$cantper', '$cedula','$viaorigen', '$viadestino','$monto','No comprado',null,'$id')");
					 }
					 else
					 {
			...
			$rodime = mysql_fetch_array($dime);
					 ...
					 if ($dimeya== NULL )
					 {
						...
						$flota1=$rohola['flo_id'];	
							 ...
							 mysql_query("INSERT INTO `presupuesto` (`pre_id`, `pre_fecha`,`pre_habitacion`,`pre_servicio`,`pre_paseo`,`pre_total`,`pre_cant_per`,`fk_per_cedula`, `fk_via_id_origen`, `fk_via_id_destino`,`pre_abono`,`pre_status`,`pre_paq`,`pre_pro`) VALUES (NULL ,'2011-06-18',null,NULL,NULL, '$total','$cantper', '$cedula','$viaorigen', '$viadestino',($monto1),'No comprado',null,'$id')");
					 }
					 else
					 {
	...
	$rodime = mysql_fetch_array($dime);
					 ...
					 ////echo("$quedate,$total,$cantper,$cedula,$viaorigen,$viadestino,($montoaux+$montoaux1+$montoaux2),$id");
							mysql_query("INSERT INTO `presupuesto` (`pre_id`, `pre_fecha`,`pre_habitacion`,`pre_servicio`,`pre_paseo`,`pre_total`,`pre_cant_per`,`fk_per_cedula`, `fk_via_id_origen`, `fk_via_id_destino`,`pre_abono`,`pre_status`,`pre_paq`,`pre_pro`) VALUES (NULL ,'2011-06-18',null,NULL,NULL, '$total','$cantper', '$cedula','$viaorigen', '$viadestino',($monto2),'No comprado',null,'$id')");
					 }
					 else
					 {
...

		{
			...
			$hola1='u_flota_errorPr_conestadia_aereo.php?mensaje=2';
      ...
      <td><input name="fecha" id="fecha" type="text" readonly="readonly" value="{fecha}" ><a href="javascript:NewCssCalNP(\'fecha\',\'YYYYMMDD\')"><img src="../js/cal.gif" width="16" height="16" border="0" alt="Seleccione una Fecha"></td>');
        ...
        <option>10</option>');
						...
						if ($selected2 && $tipopaq && $servicio && $durac && $origen && $destino  && $id && ($selected3=='a') )
						{
      ...
      <td><input name="fecha" id="fecha" type="text" readonly="readonly" value="{fecha}" ><a href="javascript:NewCssCalNP(\'fecha\',\'YYYYMMDD\')"><img src="../js/cal.gif" width="16" height="16" border="0" alt="Seleccione una Fecha"></td>');
				...
				$rocosto = mysql_fetch_array($costo);
				 ...
				 $valor1=$valor-($valor*$servicio);
					  ...
					  if ($mete!= NULL)
						{
							$total1=($valor1*$selected2)-$mete;
						 $panelestadios->add("totala",$total1);
						
						}
						else{
					         $total1=($valor1*$selected2);
						 $panelestadios->add("totala",$total1);
						}
					$panelestadios->add("aerolinea",$aerolinea);
					$panelestadios->add("origen",$origen);
				  ...
				  $panelestadios->add("durac",$durac);
					 $panelestadios->add("tipopaq",$tipopaq);
						...
						$panelestadios->add("fecha",$fechai);
							...
							{
								$panelestadios->add("pago",' <tr><td>Tipo:</td><td><select name="tipo" id="tipo"  onChange="populate2(document.form1,document.form1.formapago.options[document.form1.formapago.selectedIndex].value,document.form1.fecha.value,document.form1.fecha1.value,document.getElementById(\'aerolinea\').innerHTML,document.getElementById(\'origen\').innerHTML,document.getElementById(\'destino\').innerHTML,document.getElementById(\'servicio\').innerHTML,document.getElementById(\'durac\').innerHTML,document.getElementById(\'totala\').innerHTML,document.form1.tipo.options[document.form1.tipo.selectedIndex].value,document.getElementById(\'id\').innerHTML,document.getElementById(\'tipopaq\').innerHTML,document.form1.cantper.options[document.form1.cantper.selectedIndex].value)"><option selected="selected">Seleccione</option><option>Tarjeta</option><option>Cheque</option><option>Efectivo</option></select></td></tr>
    ');
	...
	////echo($combo);
					...
					if(($selected=="Pago Unico") && $aerolinea && $fechaf && $fechai && $origen && $destino && $servicio && $tipo && ($selected3=='c') )
				{
					////echo("basta");
					$ok1=mysql_query("SELECT `des_id` FROM  destino WHERE des_nombre='$destino'");
			                 $rowok1 = mysql_fetch_array($ok1);
      ...
      <td><input name="fecha" id="fecha" type="text" readonly="readonly" value="{fecha}" ><a href="javascript:NewCssCalNP(\'fecha\',\'YYYYMMDD\')"><img src="../js/cal.gif" width="16" height="16" border="0" alt="Seleccione una Fecha"></td>');
				...
				//aqui van los if
				if ($tipo=="Tarjeta"){
				$panelestadios->add("pago",' <tr><td>Tipo:</td><td><select name="tipo" id="tipo"  onChange="populate2(document.form1,document.form1.formapago.options[document.form1.formapago.selectedIndex].value,document.form1.fecha.value,document.form1.fecha1.value,document.getElementById(\'aerolinea\').innerHTML,document.getElementById(\'origen\').innerHTML,document.getElementById(\'destino\').innerHTML,document.getElementById(\'servicio\').innerHTML,document.getElementById(\'durac\').innerHTML,document.getElementById(\'totala\').innerHTML,document.form1.tipo.options[document.form1.tipo.selectedIndex].value,document.getElementById(\'id\').innerHTML,document.getElementById(\'tipopaq\').innerHTML,document.form1.cantper.options[document.form1.cantper.selectedIndex].value)"><option selected="selected">Seleccione</option><option selected="selected">Tarjeta</option><option>Cheque</option><option>Efectivo</option></select></td></tr>
    ');
	...
	if ($tipo=="Cheque"){
				$panelestadios->add("pago",' <tr><td>Tipo:</td><td><select name="tipo" id="tipo"  onChange="populate2(document.form1,document.form1.formapago.options[document.form1.formapago.selectedIndex].value,document.form1.fecha.value,document.form1.fecha1.value,document.getElementById(\'aerolinea\').innerHTML,document.getElementById(\'origen\').innerHTML,document.getElementById(\'destino\').innerHTML,document.getElementById(\'servicio\').innerHTML,document.getElementById(\'durac\').innerHTML,document.getElementById(\'totala\').innerHTML,document.form1.tipo.options[document.form1.tipo.selectedIndex].value,document.getElementById(\'id\').innerHTML,document.getElementById(\'tipopaq\').innerHTML,document.form1.cantper.options[document.form1.cantper.selectedIndex].value)"><option selected="selected">Seleccione</option><option>Tarjeta</option><option selected="selected">Cheque</option><option>Efectivo</option></select></td></tr>
    ');
	...
	if ($tipo=="Efectivo"){
				$panelestadios->add("pago",' <tr><td>Tipo:</td><td><select name="tipo" id="tipo"  onChange="populate2(document.form1,document.form1.formapago.options[document.form1.formapago.selectedIndex].value,document.form1.fecha.value,document.form1.fecha1.value,document.getElementById(\'aerolinea\').innerHTML,document.getElementById(\'origen\').innerHTML,document.getElementById(\'destino\').innerHTML,document.getElementById(\'servicio\').innerHTML,document.getElementById(\'durac\').innerHTML,document.getElementById(\'totala\').innerHTML,document.form1.tipo.options[document.form1.tipo.selectedIndex].value,document.getElementById(\'id\').innerHTML,document.getElementById(\'tipopaq\').innerHTML,document.form1.cantper.options[document.form1.cantper.selectedIndex].value)"><option selected="selected">Seleccione</option><option>Tarjeta</option><option>Cheque</option><option selected="selected">Efectivo</option></select></td></tr>
    ');
