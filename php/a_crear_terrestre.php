<?php
	...
	extract($_POST);
	      ...
	      if($cue_numero)
		  {
		     ...
		     $result1= mysql_query("SELECT * FROM terrestre t WHERE t.ter_nombre ='$cue_numero'");
			  ...
			  if (mysql_fetch_array($result1))
			  {
					...
					$panelcuentas = new Panel("../html/a_crear_terrestre.html");
					$panelcuentas->add("form",'<form name="form1" method="post" action="../php/a_crear_terrestre.php">');
					...
					$panelcuentas->add("error",'Ya existe esa transporte terrestre');
			  ...
			  {
				mysql_query("INSERT INTO `terrestre` (`ter_id` ,`ter_nombre` ,`ter_fecha_inicio` ,`fk_des_id`)VALUES (NULL ,'$cue_numero', '$fecha',  '$banco')");
