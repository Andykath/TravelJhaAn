<?php
	...
	extract($_POST);
		  ...
		  {//aqui pinta el editor por primera vez	
					...
					$panelestadios = new Panel("../html/a_crear_hab_hotel.html");
					$panelestadios->add("form",'<form name="form1" method="post" action="../php/a_modificar_hab_hotel.php?cue_id='.$id.'&hot_id='.$hotel.'">');
