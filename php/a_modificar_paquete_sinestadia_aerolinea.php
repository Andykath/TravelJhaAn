<?php
	...
	extract($_POST);
		  ...
		  {//aqui pinta el editor por primera vez	
					...
					$panelestadios = new Panel("../html/a_modificar_paquete_sinestadia_aerolinea.html");
					$panelestadios->add("form",'<form name="form1" method="post" action="../php/a_modificar_paquete_sinestadia_aerolinea.php?cue_id='.$id.'&cue_numero='.$nombrepro.'&fechai='.$fechai.'&fechaf='.$fechaf.'&des'.$descuento.'&dur='.$duracion.'&fkvia='.$banco.'">');
