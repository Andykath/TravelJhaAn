<?php
	...
	$panelmiperfil = new Panel("../html/a_verperfil_promocion_sinestadia_terrestre.html");
   ...
   $panelmiperfil->add("destino",$destino);
	$panelmiperfil->add("links",'<a href="../php/a_modificar_promocion_sinestadia_terrestre.php?nombrepro='.$nombrepro.'&id='.$id.'&fechai='.$fechai.'&fechaf='.$fechaf.'&descuento='.$descuento.'&duracion='.$duracion.'&fkvia='.$fkvia.'&aernombre='.$aernombre.'&aerid='.$aerid.'&destino='.$destino.'">Modificar</a> <a href="../php/a_eliminar_promocion_sinestadia_terrestre.php?proid='.$id.'" onclick="return confirmar()">Eliminar</a>');
