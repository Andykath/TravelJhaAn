<?php
	...
	//echo($locura);
		  ...
		  {// aqui validar que los datos esten bien y hacer update
				 ...
				 $hola1='u_reserva_undestino_conestadia_maritimo.php?&mensaje=2';
		  ...
		  {//aqui pinta el editor por primera vez	
					...
					$panelestadios->add("form",'<form name="form1" method="post" action="../php/u_reserva_undestino_conestadia_maritimo1.php?a=1">');
