<?php
	...
	extract($_GET);
	      ...
	      else // aqui cargo por primera vez 
		  {
			...
			$panelcuentas = new Panel("../html/a_crear_promocion_estadia_terrestre.html");
			$panelcuentas->add("form",'<form name="form1" method="post" action="../php/a_crear_promocion_estadia_terrestre.php">');
