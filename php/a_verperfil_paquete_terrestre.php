<?php
	...
	$panelmiperfil = new Panel("../html/a_verperfil_paquete_terrestres.html");
   ...
   $cedula_actual=$_SESSION['cedula'];
	...
	$panelmiperfil->add("links",'<a href="../php/a_modificar_paquete_sinestadia_terrestre.php?tipoviaje='.$tipoviaje.'&id='.$id.'&fechai='.$fechai.'&fechaf='.$fechaf.'&millas='.$millas.'&tipopaq='.$tipopaq.'&cantpaq='.$cantpaq.'&aernombre='.$aernombre.'&aerid='.$aerid.'&fkvia='.$fkvia.'&fkvia2='.$fkvia2.'">Modificar</a> <a href="../php/a_eliminar_paquete_sinestadia_terrestre.php?id='.$id.'" onclick="return confirmar()">Eliminar</a>');
