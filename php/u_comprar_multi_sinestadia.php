					  ...
					  $ter7=$row[2];
						...
						if($cru7)
						  ...
						  $via72=mysql_query("SELECT  flo_actual FROM  flota where fk_cru_id='$cru7 and (flo_actual>0)'");
						   ...
						   $reschaot=mysql_query("SELECT cru_id FROM  crucero where cru_nombre='$aerolinea'");
							$rochaot = mysql_fetch_array($reschaot);
							$aerid10=$rochaot['cru_id'];	
							
							$confirma=mysql_query("SELECT SUM(f.flo_actual) as s FROM flota f where f.fk_cru_id='$aerid10'");
							$rochaot1 = mysql_fetch_array($confirma);
							$sumando=$rochaot1['s'];	
						...
						if($ter7)
						  ...
						  $via72=mysql_query("SELECT  flo_actual FROM  flota where fk_ter_id='$ter7 and (flo_actual>0)'");
						   ...
						   $reschaot=mysql_query("SELECT ter_id FROM terrestre where ter_nombre='$aerolinea'");
							...
							$confirma=mysql_query("SELECT SUM(f.flo_actual) as s FROM flota f where f.fk_ter_id='$aerid10'");
							$rochaot1 = mysql_fetch_array($confirma);
							$sumando=$rochaot1['s'];	
...
mysql_query("INSERT INTO `estadia` (`est_id`,`est_fecha_ini`,`est_fecha_fin`,`fk_via_id`,`fk_hab_id`) VALUES(NULL,'$fecha','$fecha1','$viaje','$habitacion')");
		    ...
		    $pago2=$roc['max'];
					 ...
					 $antes=mysql_query("SELECT `pre_abono` FROM  presupuesto WHERE pre_id='$id'");
						 ...
						 $hola1='u_presupuesto_multi_sinestadia1.php?mensaje=2';
		    ...
		    $pago2=$roc['max'];
					   ...
					   mysql_query("INSERT INTO `tip_pag` (`tip_id`,`fk_pag_id`,`fk_tar_id`,`fk_che_id`,`fk_dep_id`,`fk_mil_id`) VALUES(NULL,'$pago2',NULL,NULL,'$deposito',NULL)");
						...
						{
						 $hola1='u_monto_error_sinestadia_multi.php?mensaje=2';
						header("Location:$hola1");
						}
				...
				{
				 $hola1='u_flota_error_sinestadia_multi.php?mensaje=2';
						header("Location:$hola1");
				...
				$via=mysql_query("SELECT fk_aer_id, fk_cru_id , fk_ter_id FROM  via where via_id='$mivariable'");
					  ...
					  $ter=$row[2];
							...
							$ok=mysql_query("SELECT `pre_abono` FROM  presupuesto WHERE pre_id='$id'");
							 ...
							 $camino=$total-$mete;
							 $mouse=mysql_query("SELECT `pre_habitacion` FROM  presupuesto WHERE pre_id='$id'");
			                 $rowokm = mysql_fetch_array($mouse);
		                     $metemouse=$rowokm['pre_habitacion'];
							 
	                 if ($aer && $metemouse!=NULL)
					 {
						 ////echo("entra");
						$via2=mysql_query("SELECT o.des_nombre,d.des_nombre,a.aer_nombre,ho.hot_nombre,ha.hab_id,s.ser_nombre FROM  via v, aerolinea a, destino o, destino d,presupuesto p , habitacion ha, hotel ho, via f,servicio s where v.via_id='$origen' AND f.via_id='$destino' and v.fk_aer_id=a.aer_id and v.fk_des_id=o.des_id and f.fk_des_id=d.des_id and p.pre_habitacion=ha.hab_id and ha.fk_hot_id=ho.hot_id and p.pre_servicio=s.ser_id ");
      ...
      <td><input name="fecha" id="fecha" type="text" readonly="readonly" value="{fecha}" ><a href="javascript:NewCssCalNP(\'fecha\',\'YYYYMMDD\')"><img src="../js/cal.gif" width="16" height="16" border="0" alt="Seleccione una Fecha"></td>');
							...
							$panelestadios->add("hotel",' <tr>
    <th width="128" align="left" scope="row">Hotel/Barco</th>
    <th align="left" scope="row"><div align="left" id="hotel">'.$hotelito.'</div></th>
  </tr>');
							$panelestadios->add("habitacion",'<tr>
    <th width="128" align="left" scope="row">Nro. Habitacion</th>
    <th align="left" scope="row"><div align="left" id="habitacion">'.$habilinda.'</div></th>
  </tr>');
							$panelestadios->add("servicio",' <tr>
    <th width="128" align="left" scope="row">Servicio</th>
    <th align="left" scope="row"><div align="left" id="servicio">'.$servi.'</div></th>
  </tr>');
							$panelestadios->add("total",$camino);
							$panelestadios->add("cantper",$cantper);
							$panelestadios->add("id",$id);
							$panelestadios->add("id2",$origen);
							$panelestadios->add("id3",$destino);
						$panelestadios->add("formapago",' <tr>
      <td>Forma de pago:</td>
      <td><select name="formapago" id="formapago" onChange="populate(document.form1,document.form1.formapago.options[document.form1.formapago.selectedIndex].value,document.form1.fecha.value,document.form1.fecha1.value,document.getElementById(\'aerolinea\').innerHTML,document.getElementById(\'origen\').innerHTML,document.getElementById(\'destino\').innerHTML,document.getElementById(\'total\').innerHTML,document.getElementById(\'cantper\').innerHTML,document.getElementById(\'id\').innerHTML,document.getElementById(\'id2\').innerHTML,document.getElementById(\'id3\').innerHTML,document.getElementById(\'hotel\').innerHTML,document.getElementById(\'habitacion\').innerHTML,document.getElementById(\'servicio\').innerHTML)">
       <option selected="selected">Seleccione</option>
        <option>Pago Unico</option><option>Pago en cuotas</option>
      </select>      </td>
    </tr>');
						 
						 }
						 else if ($aer && $metemouse==NULL)
						 {
      ...
      <td><input name="fecha" id="fecha" type="text" readonly="readonly" value="{fecha}" ><a href="javascript:NewCssCalNP(\'fecha\',\'YYYYMMDD\')"><img src="../js/cal.gif" width="16" height="16" border="0" alt="Seleccione una Fecha"></td>');
				...
				$panelestadios->add("formapago",' <tr>
      <td>Forma de pago:</td>
      <td><select name="formapago" id="formapago" onChange="populate(document.form1,document.form1.formapago.options[document.form1.formapago.selectedIndex].value,document.form1.fecha.value,document.form1.fecha1.value,document.getElementById(\'aerolinea\').innerHTML,document.getElementById(\'origen\').innerHTML,document.getElementById(\'destino\').innerHTML,document.getElementById(\'total\').innerHTML,document.getElementById(\'cantper\').innerHTML,document.getElementById(\'id\').innerHTML,document.getElementById(\'id2\').innerHTML,document.getElementById(\'id3\').innerHTML)">
       <option selected="selected">Seleccione</option>
        <option>Pago Unico</option><option>Pago en cuotas</option>
      </select>      </td>
    </tr>');
      ...
      <td><input name="fecha" id="fecha" type="text" readonly="readonly" value="{fecha}" ><a href="javascript:NewCssCalNP(\'fecha\',\'YYYYMMDD\')"><img src="../js/cal.gif" width="16" height="16" border="0" alt="Seleccione una Fecha"></td>');
					...
					$panelestadios->add("compuesto",$paseo);
					  ...
					  $panelestadios->add("forma",'<option>Pago Unico</option><option>Pago en cuotas</option>');
							 ...
							 if ($ter && $metemouse!=NULL)
							 {
								 $via4=mysql_query("SELECT o.des_nombre,d.des_nombre,a.ter_nombre,ho.hot_nombre,ha.hab_id,s.ser_nombre FROM  via v, terrestre a, destino o, destino d,presupuesto p , habitacion ha, hotel ho, via f,servicio s where v.via_id='$origen' AND f.via_id='$destino' and v.fk_ter_id=a.ter_id and v.fk_des_id=o.des_id and f.fk_des_id=d.des_id and p.pre_habitacion=ha.hab_id and ha.fk_hot_id=ho.hot_id and p.pre_servicio=s.ser_id ");
					...
					$panelestadios->add("compuesto",$paseo);
					  ...
					  $panelestadios->add("cantper",$cantper);
					   $panelestadios->add("id",$id);
					     $panelestadios->add("id2",$origen);
						    $panelestadios->add("id3",$destino);
							$panelestadios->add("hotel",$hotelito);
							$panelestadios->add("habitacion",$habilinda);
							$panelestadios->add("servicio",$servi);
					  $panelestadios->add("forma",'<option>Pago Unico</option><option>Pago en cuotas</option>');
							  
								 
								 }
								 else if($ter &&$metemouse==NULL)
								 {
									 
									  $via2=mysql_query("SELECT o.des_nombre,d.des_nombre,a.ter_nombre FROM  via v, terrestre a, destino o, destino d, via f where v.via_id='$origen' AND f.via_id='$destino' and v.fk_ter_id=a.ter_id and v.fk_des_id=o.des_id and f.fk_des_id=d.des_id");
						   while($row1 = mysql_fetch_array($via2))
							   {
						   $origenh = $row1[0];
						  $destinoh=	$row1[1];
        ...
        <option>Pago Unico</option><option>Pago en cuotas</option>
					...
					$via=mysql_query("SELECT fk_aer_id, fk_cru_id , fk_ter_id FROM  via where via_id='$id2'");
					  ...
					  $ter=$row[2];
	              	 ...
	              	 $cont=0;
							 $techi=mysql_query("SELECT p.pre_total FROM  presupuesto p where p.pre_paseo='$paseo'");
                       while($rowtech = mysql_fetch_array($techi))
	                      {
					             $cont=$cont+$rowtech['pre_total'];
	                         }
							  $cont1=0;
							  $techi1=mysql_query("SELECT p.pre_abono FROM  presupuesto p where p.pre_paseo='$paseo'");
                       while($rowtech1 = mysql_fetch_array($techi1))
	                      {
					             $cont1=$cont1+$rowtech1['pre_abono'];
	                         }
      ...
      <td><input name="fecha" id="fecha" type="text" readonly="readonly" value="{fecha}" ><a href="javascript:NewCssCalNP(\'fecha\',\'YYYYMMDD\')"><img src="../js/cal.gif" width="16" height="16" border="0" alt="Seleccione una Fecha"></td>');
							...
							$panelestadios->add("hotel",' <tr>
    <th width="128" align="left" scope="row">Hotel/Barco</th>
    <th align="left" scope="row"><div align="left" id="hotel">'.$hotel.'</div></th>
  </tr>');
							$panelestadios->add("habitacion",'<tr>
    <th width="128" align="left" scope="row">Nro. Habitacion</th>
    <th align="left" scope="row"><div align="left" id="habitacion">'.$habitacion.'</div></th>
  </tr>');
							$panelestadios->add("servicio",' <tr>
    <th width="128" align="left" scope="row">Servicio</th>
    <th align="left" scope="row"><div align="left" id="servicio">'.$serviio.'</div></th>
  </tr>');
			...
			if(($selected=="Pago Unico") && $aerolinea && $fechaf && $fechai && $origen && $destino && $total )
				...
				$via=mysql_query("SELECT fk_aer_id, fk_cru_id , fk_ter_id FROM  via where via_id='$id2'");
	               ...
	               if ($aer && $metemouse!=NULL)
					...
					$panelestadios->add("fechasal",'<td>Fecha de salida:</td>
      <td><input name="fecha" id="fecha" type="text" readonly="readonly" value="{fecha}" ><a href="javascript:NewCssCalR(\'fecha\',\'YYYYMMDD\')"><img src="../js/cal.gif" width="16" height="16" border="0" alt="Seleccione una Fecha"></td>'.$fechai.'');
	                }
					else if ($mete1==43 and $aerolinea=="Aserca Airlines"){
					
					$panelestadios->add("fechasal",'<td>Fecha de salida:</td>
      <td><input name="fecha" id="fecha" type="text" readonly="readonly" value="{fecha}" ><a href="javascript:NewCssCalNP(\'fecha\',\'YYYYMMDD\')"><img src="../js/cal.gif" width="16" height="16" border="0" alt="Seleccione una Fecha"></td>'.$fechai.'');
	                }
					else if ($mete1==97 and $aerolinea=="Venezolana"){
      ...
      <td><input name="fecha" id="fecha" type="text" readonly="readonly" value="{fecha}" ><a href="javascript:NewCssCalNP(\'fecha\',\'YYYYMMDD\')"><img src="../js/cal.gif" width="16" height="16" border="0" alt="Seleccione una Fecha"></td>'.$fechai.'');
					...
					$panelestadios->add("fechasal",'<td>Fecha de salida:</td>
      <td><input name="fecha" id="fecha" type="text" readonly="readonly" value="{fecha}" ><a href="javascript:NewCssCalDD(\'fecha\',\'YYYYMMDD\')"><img src="../js/cal.gif" width="16" height="16" border="0" alt="Seleccione una Fecha"></td>'.$fechai.'');
	                }
					else if ($mete1==43 and $aerolinea=="Avior airlines"){
    ...
    <th align="left" scope="row"><div align="left" id="habitacion">'.$habitacion.'</div></th>
							...
							$panelestadios->add("servicio",' <tr>
    <th width="128" align="left" scope="row">Servicio</th>
    <th align="left" scope="row"><div align="left" id="servicio">'.$servicio.'</div></th>
  </tr>');
							$panelestadios->add("total",$total);
							$panelestadios->add("cantper",$cantper);
							$panelestadios->add("id",$id);
      ...
      <td>Forma de pago:</td>
      <td><select name="formapago" id="formapago" onChange="populate(document.form1,document.form1.formapago.options[document.form1.formapago.selectedIndex].value,document.form1.fecha.value,document.form1.fecha1.value,document.getElementById(\'aerolinea\').innerHTML,document.getElementById(\'origen\').innerHTML,document.getElementById(\'destino\').innerHTML,document.getElementById(\'total\').innerHTML,document.getElementById(\'cantper\').innerHTML,document.getElementById(\'id\').innerHTML,document.getElementById(\'id2\').innerHTML,document.getElementById(\'id3\').innerHTML,document.getElementById(\'hotel\').innerHTML,document.getElementById(\'habitacion\').innerHTML,document.getElementById(\'servicio\').innerHTML)">
       <option selected="selected">Seleccione</option>'.$select2.'</select></td>
    </tr>');
    ...
    ');
      ...
      <td><input name="fecha" id="fecha" type="text" readonly="readonly" value="{fecha}" ><a href="javascript:NewCssCalNP(\'fecha\',\'YYYYMMDD\')"><img src="../js/cal.gif" width="16" height="16" border="0" alt="Seleccione una Fecha"></td>'.$fechai.'');
							...
							$panelestadios->add("aerolinea",$aerrolinea);
							$panelestadios->add("origen",$origen);
							$panelestadios->add("destino",$destino);
							$panelestadios->add("fecha1",$fechaf);
							$panelestadios->add("total",$total);
      ...
      <td>Forma de pago:</td>
      <td><select name="formapago" id="formapago" onChange="populate(document.form1,document.form1.formapago.options[document.form1.formapago.selectedIndex].value,document.form1.fecha.value,document.form1.fecha1.value,document.getElementById(\'aerolinea\').innerHTML,document.getElementById(\'origen\').innerHTML,document.getElementById(\'destino\').innerHTML,document.getElementById(\'total\').innerHTML,document.getElementById(\'cantper\').innerHTML,document.getElementById(\'id\').innerHTML,document.getElementById(\'id2\').innerHTML,document.getElementById(\'id3\').innerHTML)">
       <option selected="selected">Seleccione</option>'.$select2.'</select></td></tr>');
	   
	     $panelestadios->add("pago",' <tr><td>Tipo:</td><td><select name="tipo" id="tipo"  onChange="populate2(document.form1,document.form1.formapago.options[document.form1.formapago.selectedIndex].value,document.form1.fecha.value,document.form1.fecha1.value,document.getElementById(\'aerolinea\').innerHTML,document.getElementById(\'origen\').innerHTML,document.getElementById(\'destino\').innerHTML,document.getElementById(\'total\').innerHTML,document.getElementById(\'cantper\').innerHTML,document.form1.tipo.options[document.form1.tipo.selectedIndex].value,document.getElementById(\'id\').innerHTML,document.getElementById(\'id2\').innerHTML,document.getElementById(\'id3\').innerHTML)"><option selected="selected">Seleccione</option><option>Tarjeta</option><option>Cheque</option><option>Efectivo</option></select></td></tr>
    ');
    ...
    <th align="left" scope="row"><div align="left" id="servicio">'.$servicio.'</div></th>
      ...
      <td><input name="fecha" id="fecha" type="text" readonly="readonly" value="{fecha}" ><a href="javascript:NewCssCalNP(\'fecha\',\'YYYYMMDD\')"><img src="../js/cal.gif" width="16" height="16" border="0" alt="Seleccione una Fecha"></td>');
					...
					$panelestadios->add("fechasal",'<td>Fecha de salida:</td>
      <td><input name="fecha" id="fecha" type="text" readonly="readonly" value="{fecha}" ><a href="javascript:NewCssCalNP(\'fecha\',\'YYYYMMDD\')"><img src="../js/cal.gif" width="16" height="16" border="0" alt="Seleccione una Fecha">'.$fechai.'</td>');
	                }
							$panelestadios->add("aerolinea",$terh);
							$panelestadios->add("origen",$origenh);
							$panelestadios->add("destino",$destinoh);
							$panelestadios->add("fecha1",$fechai);
							$panelestadios->add("total",$camino);
							$panelestadios->add("cantper",$cantper);
							$panelestadios->add("id",$id);
							$panelestadios->add("id2",$id2);
