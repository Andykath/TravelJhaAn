	...
	extract($_GET);
	      if($cue_numero)
		  {
			...
			// echo($hot_id);
				...
				$hola='a_paquetes_estadia_terrestre.php?mensaje=1';
	      ...
	      else
		  {
			...
			$panelcuentas = new Panel("../html/a_crear_paquete_estadia_terrestre.html");
			$panelcuentas->add("form",'<form name="form1" method="post" action="../php/a_crear_paquete_estadia_terrestre.php">');
